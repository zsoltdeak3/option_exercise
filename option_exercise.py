...
st.sidebar.markdown("<h4 style='text-align: center; font-size:18px; margin-bottom: -20px;'>Client option exercise approach</h4>", unsafe_allow_html=True)
add_selectbox = st.sidebar.selectbox("",("Random scatter","Pro rata"))
